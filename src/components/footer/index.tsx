            ...
            <div id='footer' className='sm:px-28 xs:px-6'>
                <div className='grid sm:grid-cols-3 xs:grid-cols-1 gap-16 pt-20'>
                    <div className='flex flex-col gap-3 text-white'>
                        ...
                        <p className='pt-2 text-[15px]'>The Nigerian Institute of Architects Kaduna Chapter was founded on the 11th of November 1972, as an association of independent professional architects with the aim of fostering friendship.</p>
